...
df.t %>%
  ...
  labs(subtitle = paste0('Proportion of times 1 was recovered on graph of size n = ', graph_size[10]),
       title = 'Pref. Attm. Model on Tree - Metric: Minimum Maximum Subgraph',
       x = 'K', y = 'Recovery Rate') +
...
pa.recovered.1.phi %>%
  ...
  labs(subtitle = 'Proportion of times 1 was recovered when returning K = 20 vertices',
       title = 'Pref. Attm. Model on Tree - Metric: Minimum Maximum Subgraph',
...
df.t %>%
  ...
  scale_y_continuous(limits = c(0, 1), labels = proportion.cuts, breaks = proportion.cuts) +
  labs(subtitle = paste0('Proportion of times 1 was recovered on graph of size n = ', graph_size[10]),
       title = 'Pref. Attm. Model on Tree - Metric: Maximum Degree',
       x = 'K', y = 'Recovery Rate') +
  theme(plot.background = element_rect(fill = 'white'),
        panel.background = element_rect(fill = 'white'),
        axis.text.x = element_text(size=12, angle=0),
...
df.melted %>%
  ...
  scale_x_continuous(limits = c(5000,80000), labels = graph_size, breaks = graph_size) +
  scale_y_continuous(limits = c(0,1), labels = proportion.cuts, breaks = proportion.cuts) +
  labs(subtitle = 'Proportion of times 1 was recovered over graph sizes and K = 1,5,20',
       title = 'Pref. Attm. Model - Comparison: Minimum Maximum Subgraph vs. Maximum Degree',
       x = 'Graph Size', y = 'Proportion') +
  theme(plot.background = element_rect(fill = 'white'),
        panel.background = element_rect(fill = 'white'),
        axis.text.x = element_text(size=12, angle=45),
...
df.melted %>%
  ...
  labs(subtitle = 'Proportion of times 1 was recovered over K = 1, 2, 3, 4, 5',
       title = 'Pref. Attm. Model on Tree - Difference in Recovery rate between
       Minimum Maximum Subgraph and Maximum Degree',
       x = 'Graph Size', y = 'Difference in Proportion') +
  theme(plot.background = element_rect(fill = 'white'),
        panel.background = element_rect(fill = 'white'),
        axis.text.x = element_text(size=12, angle=45),
        axis.text.y = element_text(size=12, angle=0),
...
df.melted %>%
  ...
  labs(subtitle = 'Proportion of times 1 was recovered over K = 1, 2, 3, 4, 5',
       title = 'Pref. Attm. Model on Tree - Metric: Minimum Maximum Subgraph 
       conditioned on Vertices of Maximum Degrees',
       x = 'Graph Size', y = 'Proportion') +
  theme(plot.background = element_rect(fill = 'white'),
        panel.background = element_rect(fill = 'white'),
        axis.text.x = element_text(size=12, angle=0),
